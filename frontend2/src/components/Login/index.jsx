      ...
      <form onSubmit={handleSubmit}>
        <div className="flex flex-col items-center gap-5">
          ...
          <div className="space-x-4">
            ...
            <input type="password" id="senha" className="p-1 rounded-3xl" onChange={(e) => setSenha(e.target.value)} value={senha || ""} />
          </div>
          {!loading && <button className="text-white bg-second-color rounded-3xl font-bold w-[110px] p-2 ml-[3.8rem]">
            Entrar
          </button>}
